...
export class ReportDownloadPopupComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // else if (this.pageName == "trackingcancle") {
    //   this.trackingcancle()
    // }
  }

  // async trackingcancle(){
  //   this.Temparray = [];
  ...
  //           }
  //           //if(ListInput.invoice_status == "invoiced"){
  ...
  //           //ExportArrayInput.Organization_Name = entry1.org_name
  ...
  //           }
  //           // else  if ( ListInput.invoice_status == "Cancelled") {
  //           // }
  //           else {
  ...
  //           ExportArrayInput.Division_ID = entry1.division_id
  //           ExportArrayInput.Division_Name = entry1.division_name
  ...
  //           this.Temparray.push(ExportArrayInput)
  //         }
  //         this.excelService.exportAsExcelFileTracking(this.Temparray, this.data.invoice_status);
  ...
  // }
  // trackingcancleExcel(ExportArrayInput, filename) {
  //   this.TemparrayALL.push(ExportArrayInput)
  //   this.pendingcount = this.TemparrayALL.length
  //   if (this.TemparrayALL.length == this.count) {
  //     this.TemparrayALL.sort((a: any, b: any) => { return Date.parse(b.Tackdatefosot) - Date.parse(a.Tackdatefosot) });
  //     this.TemparrayALL.forEach(function (x) { delete x.Tackdatefosot });
  //     this.excelService.exportAsExcelFile(this.TemparrayALL, filename);
  //     this.modalService.dismissAll();
  //   }
  // }
